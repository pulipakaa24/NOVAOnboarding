...
static const _Flip_type_support_symbol_names_t _Flip_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, adipu_turtlesim_controller, msg, Flip)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, adipu_turtlesim_controller, msg, Flip)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, adipu_turtlesim_controller, msg, Flip)() {
  return &::adipu_turtlesim_controller::msg::rosidl_typesupport_c::Flip_message_type_support_handle;
}
