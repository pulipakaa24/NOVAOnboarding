...
{
  new (message_memory) adipu_msg::msg::Flip(_init);
}

void Flip_fini_function(void * message_memory)
{
  auto typed_message = static_cast<adipu_msg::msg::Flip *>(message_memory);
  typed_message->~Flip();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Flip_message_member_array[1] = {
  {
    ...
    offsetof(adipu_msg::msg::Flip, structure_needs_at_least_one_member),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Flip_message_members = {
  "adipu_msg::msg",  // message namespace
  "Flip",  // message name
  1,  // number of fields
  sizeof(adipu_msg::msg::Flip),
...
{
  return &::adipu_msg::msg::rosidl_typesupport_introspection_cpp::Flip_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, adipu_msg, msg, Flip)() {
  return &::adipu_msg::msg::rosidl_typesupport_introspection_cpp::Flip_message_type_support_handle;
}
